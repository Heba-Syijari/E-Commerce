...
const stripePromise = loadStripe(
  "pk_test_51Mbh7WGrCNrRCbT73zd9jaSWeldR6ZUpAmu7VVLOaEagMQ455cV0cxCAW7WuIjrV1kEHaCQKf2ovpn2vt72ybKVl00JVQkeYnW"
);
        ...
        <div className="space-y-2">
          ...
          {savings > 0 && (
            <dl className="flex items-center justify-between gap-4">
              ...
              <dd className="text-base font-medium text-cyan-400">
                -${formattedSavings}
              </dd>
            </dl>
          )}
          ...
          <dl className="flex items-center justify-between gap-4 border-t border-gray-600 pt-2">
            ...
            <dd className="text-base font-bold text-cyan-400">
              ${formattedTotal}
            </dd>
          </dl>
        </div>
